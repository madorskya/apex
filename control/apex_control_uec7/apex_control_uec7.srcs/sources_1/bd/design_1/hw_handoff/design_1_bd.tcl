...
proc create_hier_cell_reg_bank { parentCell nameHier } {
  ...
  connect_bd_net -net In9_1 [get_bd_pins In9] [get_bd_pins xlconcat_0/In9] [get_bd_pins xlconcat_0/In10]
...
proc create_hier_cell_chip2chip_bot_ff { parentCell nameHier } {
  ...
  connect_bd_net -net Net1 [get_bd_pins gt0_rxprbssel_in] [get_bd_pins axi_chip2chip_0_aurora8/gt0_txprbssel_in]
  ...
  connect_bd_net -net axi_chip2chip_0_aurora9_rx_aligned [get_bd_pins axi_chip2chip_0_aurora8/tx_aligned] [get_bd_pins axi_chip2chip_0_aurora9/rx_aligned]
  connect_bd_net -net axi_chip2chip_0_aurora9_rx_reset [get_bd_pins axi_chip2chip_0_aurora8/tx_reset] [get_bd_pins axi_chip2chip_0_aurora9/rx_reset]
  connect_bd_net -net axi_chip2chip_0_aurora9_rx_verify [get_bd_pins axi_chip2chip_0_aurora8/tx_verify] [get_bd_pins axi_chip2chip_0_aurora9/rx_verify]
  connect_bd_net -net axi_chip2chip_0_aurora_pma_init_out [get_bd_pins axi_chip2chip_0/aurora_pma_init_out] [get_bd_pins axi_chip2chip_0_aurora8/gt_reset] [get_bd_pins axi_chip2chip_0_aurora9/gt_reset]
  connect_bd_net -net axi_chip2chip_0_aurora_reset_pb [get_bd_pins axi_chip2chip_0/aurora_reset_pb] [get_bd_pins axi_chip2chip_0_aurora8/tx_system_reset] [get_bd_pins axi_chip2chip_0_aurora9/rx_system_reset]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_link_status_out [get_bd_pins axi_c2c_link_status_out] [get_bd_pins axi_chip2chip_0/axi_c2c_link_status_out]
