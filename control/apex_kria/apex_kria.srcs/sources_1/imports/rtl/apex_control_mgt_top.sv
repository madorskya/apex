...
(
    ...
    wire g10s_rxp;
    wire g10s_rxn;
    wire gem_mdio_coma = 1'b0;
    wire gem_mdio_nreset = 1'b1;
    wire [7:0] ha;
    wire uart_dev2usb;
    wire uart_usb2dev;
    ...
    // the assignment below works, but sometimes leads to very weird Vivado behavior.
    // made by TCL script post-synthesis instead
