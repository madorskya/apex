...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_AXI_ADDR_WIDTH {27} \
   ...
   CONFIG.C_SLOT_1_AXI_ADDR_WIDTH {27} \
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net net_slot_0_axi_arburst [get_bd_pins g_inst/m_slot_0_axi_arburst] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net net_slot_0_axi_arcache [get_bd_pins g_inst/m_slot_0_axi_arcache] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net net_slot_0_axi_arid [get_bd_pins g_inst/m_slot_0_axi_arid] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net net_slot_0_axi_arlen [get_bd_pins g_inst/m_slot_0_axi_arlen] [get_bd_pins ila_lib/probe7]
  connect_bd_net -net net_slot_0_axi_arlock [get_bd_pins g_inst/m_slot_0_axi_arlock] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net net_slot_0_axi_arprot [get_bd_pins g_inst/m_slot_0_axi_arprot] [get_bd_pins ila_lib/probe9]
  connect_bd_net -net net_slot_0_axi_arqos [get_bd_pins g_inst/m_slot_0_axi_arqos] [get_bd_pins ila_lib/probe10]
  ...
  connect_bd_net -net net_slot_0_axi_awqos [get_bd_pins g_inst/m_slot_0_axi_awqos] [get_bd_pins ila_lib/probe20]
