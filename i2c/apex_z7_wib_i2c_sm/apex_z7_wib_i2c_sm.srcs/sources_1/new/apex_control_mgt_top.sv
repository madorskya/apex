...
`endif        
        ...
        .local_i2c_scl_i(local_i2c_scl_i), // ok
        .local_i2c_scl_o(local_i2c_scl_o), // un
        .local_i2c_scl_t(local_i2c_scl_t), // ok
        .local_i2c_sda_i(local_i2c_sda_i), // ok
        .local_i2c_sda_o(local_i2c_sda_o), // un
